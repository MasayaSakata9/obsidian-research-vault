...
Task: verify the latest paper summary from the reader job. The reader output is injected above as context. Re-open the paper URL/PDF when possible and check whether the summary is correct.
